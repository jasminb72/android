...
public class DetailActivity extends AppCompatActivity
{
	...
	private static final String TAG_EXEMPLE_FRAGMENT = "TAG_EXEMPLE_FRAGMENT";
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		// on ajoute ExempleFragment dynamiquement :
		ExempleFragment exempleFragment = new ExempleFragment();
		getSupportFragmentManager().beginTransaction().add(R.id.activity_detail, exempleFragment, TAG_EXEMPLE_FRAGMENT).commit();
	}
