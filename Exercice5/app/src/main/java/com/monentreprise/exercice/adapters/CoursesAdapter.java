...
public class CoursesAdapter extends RecyclerView.Adapter<CourseHolder>
{
	...
	// Liste d'items :
	private List<CourseItem> listeCoursesItems = null;
	 ...
	 */
	public CoursesAdapter(List<CourseItem> listeCoursesItems)
	{
...
//		notifyItemChanged(listeCoursesItems.size() - 1);
		return true;
	}
...
//			notifyItemRangeChanged(position, listeCoursesItems.size());
		}
	}
